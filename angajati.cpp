...
Angajat::Angajat(const Angajat &angajat){                                                                                                        
    ...
    //getteri
        ...
        void Angajat::preiaRezervare(const Rezervari &rezervareNoua){                                     //functie pentru preluarea rezervarilor de catre ospatari
        ...
        void Angajat::reviewOspatar(int nota) {                                                         //functie pentru review a ospatarului
